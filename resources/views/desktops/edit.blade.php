    ...
    <x-dashboard.sidebar>
        ...
        <div class="flex justify-center px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-4xl bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-md">
                ...
                {{-- Form --}}
                <form action="{{ route('desktops.update', $desktop->id) }}" method="POST" class="space-y-6"
                    onsubmit="showFullScreenLoader(); return confirm('Update this desktop?')">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="hostname" name="hostname" type="text"
                                value="{{ old('hostname', $desktop->hostname) }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="serialnumber" name="serialnumber" type="text"
                                value="{{ old('serialnumber', $desktop->serialnumber) }}" class="mt-1 block w-full"
                                required />
                        ...
                        <div>
                            ...
                            <x-text-input id="model" name="model" type="text"
                                value="{{ old('model', $desktop->model) }}" class="mt-1 block w-full" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="brand" name="brand" type="text"
                                value="{{ old('brand', $desktop->brand) }}" class="mt-1 block w-full" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="user" name="user" type="text"
                                value="{{ old('user', $desktop->user) }}" class="mt-1 block w-full" />
                            <x-input-error :messages="$errors->get('user')" class="mt-2" />
                        </div>

                        {{-- Location (foreign store) --}}
                        <div>
                            ...
                            <select id="location" name="location" required
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id }}"
                                        {{ old('location', $desktop->location) == $store->id ? 'selected' : '' }}>
                                        {{ $store->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="typewindows" name="typewindows" type="text"
                                value="{{ old('typewindows', $desktop->typewindows) }}" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="osstatus" name="osstatus" type="text"
                                value="{{ old('osstatus', $desktop->osstatus) }}" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="iprealvnc" name="iprealvnc" type="text"
                                value="{{ old('iprealvnc', $desktop->iprealvnc) }}" class="mt-1 block w-full" />
