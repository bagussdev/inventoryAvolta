...
@if (isset($incident) && (strtolower($incident->status) === 'resolved' || strtolower($incident->status) === 'completed'))
...
@push('scripts')
    <script>
        ...
        // Here we only refer to $incident because this partial is within the incident folder
        let usedSpareparts = @json($incident->usedSpareParts ?? []);
