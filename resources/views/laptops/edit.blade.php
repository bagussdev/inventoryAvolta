    ...
    <x-dashboard.sidebar>
        ...
        <div class="flex justify-center px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-4xl bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-md">
                ...
                {{-- Form --}}
                <form action="{{ route('laptops.update', $laptop->id) }}" method="POST" class="space-y-6"
                    onsubmit="showFullScreenLoader(); return confirm('Update this laptop?')">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="serialnumber" name="serialnumber" type="text"
                                value="{{ old('serialnumber', $laptop->serialnumber) }}" class="mt-1 block w-full"
                                required />
                        ...
                        <div>
                            ...
                            <x-text-input id="model" name="model" type="text"
                                value="{{ old('model', $laptop->model) }}" class="mt-1 block w-full" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="brand" name="brand" type="text"
                                value="{{ old('brand', $laptop->brand) }}" class="mt-1 block w-full" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="user" name="user" type="text"
                                value="{{ old('user', $laptop->user) }}" class="mt-1 block w-full" />
                            ...
                            <select id="location" name="location" required
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id }}"
                                        {{ old('location', $laptop->location) == $store->id ? 'selected' : '' }}>
                                        {{ $store->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="typewindows" name="typewindows" type="text"
                                value="{{ old('typewindows', $laptop->typewindows) }}" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="osstatus" name="osstatus" type="text"
                                value="{{ old('osstatus', $laptop->osstatus) }}" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="iprealvnc" name="iprealvnc" type="text"
                                value="{{ old('iprealvnc', $laptop->iprealvnc) }}" class="mt-1 block w-full" />
