<x-app-layout>
    <x-dashboard.sidebar>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5" id="maintenance-completed">
            ...
            <table class="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 text-center">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th class="px-5 py-4 cursor-pointer sort" data-sort="resolved_at">Resolved At</th>
                ...
                <tbody class="list">
                            ...
                            <td class="px-3 py-2">
                                <div class="flex flex-col sm:flex-row flex-wrap gap-2 justify-center">
                                    <x-buttons.action-button text="Detail" color="purple"
                                        href="{{ route('maintenances.showCompletedDetail', $maintenance->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="11" class="text-center py-4">No completed maintenance data found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        @push('scripts')
            <script>
                const maintenanceCompleted = new List('maintenance-completed', {
                    valueNames: ['no', 'id', 'name', 'model', 'brand', 'store', 'freq', 'date', 'status', 'resolved_at']
                });
            </script>
        @endpush
