...
<div id="confirmDeleteRowModal"
    class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex justify-center items-center p-4 overflow-y-auto max-h-screen">
    <div
...
<div id="confirmApplyChangesModal"
    ...
    <div
        ...
        <p class="text-gray-700 dark:text-gray-300 text-center mb-6">Are you sure you want to apply these changes?</p>
        <div class="flex justify-end gap-3 flex-wrap">
...
@push('scripts')
    <script>
        ...
        // We now specifically refer to $maintenance as this partial is in the maintenance folder
        ...
        function addSparepartRow(usedSp = null) {
            if (Object.keys(allSpareparts).length === 0) {
                alert('No spare parts available in the inventory.'); // Consider a custom modal for this alert too
                return;
            }
